...
export default function IssueOption({ name }: IssueOptionProps) {
  ...
  return (
    <motion.div
      ...
      } select-none box-border bg-neutral-400/25 backdrop-blur-xl w-full min-w-fit text-nowrap p-4 first-of-type:rounded-t-2xl last-of-type:rounded-b-2xl cursor-pointer`}
      initial={{}}
